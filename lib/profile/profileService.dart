...
class ProfileService {
  ...
  static Future<Map<String, dynamic>> updateInformation(
      {required String id, required String nombre, required String pais, required String ciudad, required String direccion, required String correo}) async {
    final Map<String, String> body = {"Action": "ActualizarCuenta", "id": id, "nombre": nombre, "pais": pais, "ciudad": ciudad, "direccion": direccion, "correo": correo};
